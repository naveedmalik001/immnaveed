    ...
    <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end gap-3 font-sans select-none">
      ...
      >
        ...
        <a
          ...
          className="w-11 h-11 bg-[#041E42] border border-slate-700/80 rounded-2xl flex items-center justify-center shadow-lg hover:border-[#14B8C4] transition-all duration-150 relative group"
        ...
        <a
          ...
          onClick={playClick}
          onMouseEnter={playHover}
          className="w-11 h-11 bg-[#25D366] rounded-2xl flex items-center justify-center shadow-lg hover:bg-[#20bd5a] transition-all duration-150 relative group"
          aria-label="WhatsApp"
        >
      ...
      <button
        ...
        className="md:hidden w-11 h-11 bg-[#14B8C4] text-[#031730] rounded-2xl flex items-center justify-center shadow-xl cursor-pointer"
