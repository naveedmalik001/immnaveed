        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="card-clean p-8 sm:p-12 bg-[#0E2849]">
            ...
            <div className="space-y-6 text-sm text-slate-300 leading-relaxed font-normal">
              ...
              <h2 className="text-lg font-bold text-white pt-4">1. Information Collection</h2>
              <p>
              ...
              <h2 className="text-lg font-bold text-white pt-4">3. Confidentiality &amp; Non-Disclosure</h2>
              <p>
              ...
              <p>
                For privacy inquiries or data requests, contact us directly at <a href="mailto:business@immnaveed.in" className="text-[#00D2D3] underline font-semibold">business@immnaveed.in</a> or +91 9018636473.
              </p>
            </div>
          </div>
        </div>
